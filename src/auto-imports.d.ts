...
declare global {
  ...
  const AppSwitcher: typeof import('./components/mobile/controls/AppSwitcher')['default']
  ...
  const ControlCenter: typeof import('./components/mobile/controls/ControlCenter')['default']
  ...
  const NotificationCenter: typeof import('./components/mobile/controls/NotificationCenter')['default']
